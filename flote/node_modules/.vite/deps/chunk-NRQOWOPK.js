...
// node_modules/@nextui-org/accordion/dist/chunk-XGGOPONM.mjs
...
function useAccordionItem(props) {
  ...
  const getHeadingProps = (0, import_react2.useCallback)(
    (props2 = {}) => {
      return {
        "data-open": dataAttr(isOpen),
        "data-disabled": dataAttr(isDisabled),
  ...
  const getSubtitleProps = (0, import_react2.useCallback)(
    (props2 = {}) => {
      return {
        "data-open": dataAttr(isOpen),
        "data-disabled": dataAttr(isDisabled),
...
// node_modules/@nextui-org/accordion/dist/chunk-HYTFRFNK.mjs
...
function useMeasure() {
  ...
  const previousObserver = (0, import_react3.useRef)(null);
  const customRef = (0, import_react3.useCallback)((node) => {
...
var ResizablePanel = (0, import_react4.forwardRef)(
  (originalProps, ref) => {
    const { children, ...props } = originalProps;
    let [measureRef, bounds] = useMeasure();
    return (0, import_jsx_runtime59.jsx)(LazyMotion, { features: domAnimation, children: (0, import_jsx_runtime59.jsx)(
      m.div,
      {
        ref,
        animate: {
        ...
        children: (0, import_jsx_runtime59.jsx)("div", { ref: measureRef, ...props, children })
      }
    ) });
  }
);
...
var AccordionItem = forwardRef((props, ref) => {
  ...
  const indicatorContent = (0, import_react5.useMemo)(() => {
    if (typeof indicator === "function") {
      return indicator({ indicator: (0, import_jsx_runtime60.jsx)(ChevronIcon, {}), isOpen, isDisabled });
    }
    if (indicator)
      return indicator;
    return null;
  }, [indicator, isOpen, isDisabled]);
  const indicatorComponent = indicatorContent || (0, import_jsx_runtime60.jsx)(ChevronIcon, {});
  const content = (0, import_react5.useMemo)(() => {
    if (disableAnimation) {
      return (0, import_jsx_runtime60.jsx)("div", { ...getContentProps(), children });
    }
    const transitionVariants = {
      exit: { ...TRANSITION_VARIANTS.collapse.exit, overflowY: "hidden" },
      enter: { ...TRANSITION_VARIANTS.collapse.enter, overflowY: "unset" }
    };
    return keepContentMounted ? (0, import_jsx_runtime60.jsx)(LazyMotion, { features: domAnimation, children: (0, import_jsx_runtime60.jsx)(
      m.section,
      {
        ...
        ...motionProps,
        children: (0, import_jsx_runtime60.jsx)("div", { ...getContentProps(), children })
      },
      "accordion-content"
    ) }) : (0, import_jsx_runtime60.jsx)(AnimatePresence, { initial: false, children: isOpen && (0, import_jsx_runtime60.jsx)(LazyMotion, { features: domAnimation, children: (0, import_jsx_runtime60.jsx)(
      m.section,
      {
        animate: "enter",
        exit: "exit",
  ...
  return (0, import_jsx_runtime60.jsxs)(Component, { ...getBaseProps(), children: [
    (0, import_jsx_runtime60.jsx)(HeadingComponent, { ...getHeadingProps(), children: (0, import_jsx_runtime60.jsxs)("button", { ...getButtonProps(), children: [
      startContent && (0, import_jsx_runtime60.jsx)("div", { className: slots.startContent({ class: classNames == null ? void 0 : classNames.startContent }), children: startContent }),
      (0, import_jsx_runtime60.jsxs)("div", { className: slots.titleWrapper({ class: classNames == null ? void 0 : classNames.titleWrapper }), children: [
        title && (0, import_jsx_runtime60.jsx)("span", { ...getTitleProps(), children: title }),
        subtitle && (0, import_jsx_runtime60.jsx)("span", { ...getSubtitleProps(), children: subtitle })
      ] }),
      !hideIndicator && indicatorComponent && (0, import_jsx_runtime60.jsx)("span", { ...getIndicatorProps(), children: indicatorComponent })
    ] }) }),
    content
  ] });
});
...
// node_modules/@nextui-org/accordion/dist/chunk-PNGZVYML.mjs
...
function $875d6693e12af071$export$728d6ba534403756(props) {
  ...
  let disabledKeys = (0, import_react6.useMemo)(() => props.disabledKeys ? new Set(props.disabledKeys) : /* @__PURE__ */ new Set(), [
    props.disabledKeys
  ]);
  let tree = (0, $7613b1592d41b092$export$6cd28814d92fa9c9)(props, (0, import_react6.useCallback)((nodes) => new (0, $05ca4cd7c4a5a999$export$863faf230ee2118a)(nodes, {
    expandedKeys
  }), [
    expandedKeys
  ]), null);
...
function useAccordion(props) {
  ...
  const shouldFilterDOMProps = typeof Component === "string";
  const domRef = useDOMRef(ref);
  const classNames = (0, import_react8.useMemo)(
    () => accordion({
      variant,
      className
    }),
  ...
  const children = (0, import_react8.useMemo)(() => {
    let treeChildren = [];
    import_react7.default.Children.map(childrenProp, (child) => {
      var _a2;
      if (import_react7.default.isValidElement(child) && typeof ((_a2 = child.props) == null ? void 0 : _a2.children) !== "string") {
        const clonedChild = import_react7.default.cloneElement(child, {
          hasChildItems: false
        });
  ...
  const values = (0, import_react8.useMemo)(
    () => ({
      state,
      focusedKey,
      motionProps,
  ...
  const getBaseProps = (0, import_react7.useCallback)((props2 = {}) => {
    return {
      ref: domRef,
  ...
  const handleFocusChanged = (0, import_react7.useCallback)((isFocused, key) => {
...
// node_modules/@nextui-org/accordion/dist/chunk-PN4MRYMG.mjs
...
var AccordionGroup = forwardRef((props, ref) => {
  ...
  const handleFocusChanged = (0, import_react9.useCallback)(
  ...
  const content = (0, import_react9.useMemo)(() => {
    return [...state.collection].map((item, index) => {
      ...
      return (0, import_jsx_runtime61.jsxs)(import_react9.Fragment, { children: [
        ...
        !item.props.hidden && !isSplitted && showDivider && index < state.collection.size - 1 && (0, import_jsx_runtime61.jsx)(divider_default, { ...dividerProps })
      ] }, item.key);
    });
  }, [values, itemClasses, handleFocusChanged, isSplitted, showDivider, state.collection]);
  return (0, import_jsx_runtime61.jsx)(Component, { ...getBaseProps(), children: disableAnimation ? content : (0, import_jsx_runtime61.jsx)(LayoutGroup, { children: content }) });
});
...
//# sourceMappingURL=chunk-NRQOWOPK.js.map
